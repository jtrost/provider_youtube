...
**Max Results** The maximum number of items to return with each API call[3].
**Start Index** The position in the user's upload history to begin importing items[4].
