...
user's username, makes an API call to get that user's uploads (https://developers.google.com/youtube/2.0/developers_guide_protocol_video_feeds#User_Uploaded_Videos), and creates nodes
for each uploaded video returned from the API call.

=== Installation
1) Download and enable the Providers module(https://drupal.org/sandbox/jtrost/2049659).
